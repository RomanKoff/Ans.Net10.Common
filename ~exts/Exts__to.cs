...
namespace Ans.Net10.Common
{
	...
	/// <summary>
	/// Предоставляет высокопроизводительные методы расширения для трансформации типов, 
	/// разбиения коллекций на блоки и быстрого парсинга строк в числовые массивы.
	/// </summary>
